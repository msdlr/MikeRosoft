...
namespace MikeRosoft.Controllers
{
    public class RecommendationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdRecommendation,name,date,description,Adminid")] Recommendation recommendation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRecommendation,name,date,description,Adminid")] Recommendation recommendation)
        {
        ...
        public IActionResult SelectProductsForRecommendation(string ProductTitle)
        {
            SelectProductsForRecommendation selectProducts = new SelectProductsForRecommendation();
            //selectProducts.atributofiltro = new SelectList(_context.atributofiltro.Select(g->g.nombre).ToList());
            //selectProducts.product = _context.product.include(a => a.atributofiltro).where
            return View();
        }
    }
}
